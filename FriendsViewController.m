...
-(void)viewWillAppear:(BOOL)animated {
    [self.navigationItem setTitle:@"My Friends"];
    segueForward = false;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ChatFrameViewController *cfvc = [[ChatFrameViewController alloc] init];
    cfvc = [segue destinationViewController];
    [cfvc setOtherUser:segueData];
}
@end